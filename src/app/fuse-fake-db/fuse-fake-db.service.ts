...
import { BranchesFakeDb } from './branches';
...
import { BranchMgtFakeDb } from './branchmgt';
import {MedicationFakeDb} from './Medication';
...
export class FuseFakeDbService implements InMemoryDbService
{
    createDb()
    {
        return {
            ...
            // // Branch
            'branches'  : BranchesFakeDb.branches,
            // 'branches'  : BranchesFakeDB.user

            // // Branch Mgt
            'branchmgt'  : BranchMgtFakeDb.branches,

            //Medication
           'medication-medication' : MedicationFakeDb.medication,
