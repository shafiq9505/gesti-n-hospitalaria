...
export class FuseScrumboardBoardListComponent implements OnInit, OnDestroy
{
    ...
    ngOnInit()
    {
        this.onBoardChanged =
            this.scrumboardService.onBoardChanged
                .subscribe(board => {
                    console.log("list board changed");
    ...
    onCardAdd(newCardName)
    {
        ...
        // this.scrumboardService.addCard(this.list.id, new Card({name: newCardName.name,type: newCardName.type}));
        console.log("onCardAdd");
        console.log(new Card(newCardName));
        this.scrumboardService.addCard(this.list.id, new Card(newCardName));
    ...
    {
        console.log("openCardDialog: " + cardId)
