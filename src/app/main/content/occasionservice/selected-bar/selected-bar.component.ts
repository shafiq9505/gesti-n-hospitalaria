...
export class FuseContactsSelectedBarComponent implements OnInit
{
    ...
    constructor(
        private contactsService: OccasionserviceService,
        ...
        this.contactsService.onSelectedContactsChanged
            .subscribe(selectedContacts => {
                ...
                setTimeout(() => {
                    ...
                    this.isIndeterminate = (selectedContacts.length !== this.contactsService.occassion.length && selectedContacts.length > 0);
                }, 0);
            });
