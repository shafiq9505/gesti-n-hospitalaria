...
export class ContactsService implements Resolve<any>
{
    ...
    getMedicationData(): Promise<any>
    {
        return new Promise((resolve, reject) => {
            this.afs.collection<medicationConfig>('medicationConfig').snapshotChanges().map(action =>{
                return action.map (action =>{
                  const data = action.payload.doc.data() as medicationConfig;
    ...
    {
        console.log(guid);
        return this.afs.doc<medicationConfig>('medicationConfig/' + contact.id).set(contact);
    ...
    {
        return this.afs.doc<medicationConfig>('medicationConfig/' + contact.id).delete();
    }
